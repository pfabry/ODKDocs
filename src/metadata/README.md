 ...
 * [ODKDocs.yml](ODKDocs.yml)
     * Determines how your purl.obolibrary.org/obo/ODKDocs/ redirects will be handled
     ...
     * Paste in the contents of [ODKDocs.yml](ODKDocs.yml)
 ...
 * [ODKDocs.md](ODKDocs.md)
     ...
     * Paste in the contents of [ODKDocs.md](ODKDocs.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
